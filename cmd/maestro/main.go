...
var (
	...
	flagFleetEndpoints = app.Flag("etcd", "etcd / fleet endpoints to connect").Short('e').Default("http://172.17.8.101:2379,http://172.17.8.102:2379,http://172.17.8.103:2379").String()
